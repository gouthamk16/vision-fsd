...
def _render_view(
    ...
    bev_resolution,
    bev_scale,
    # Kept though the current view set doesn't read them: _render_view's
    # signature is the stable interface every view branch dispatches against,
    # and in-flight views on other branches (track_bev) do use them.
